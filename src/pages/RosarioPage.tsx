...
const MISTERIOS_SAO_LUIS = [
  ...
  },
  {
    ...
    acento: 'border-gold-500',
    lista: [
      { numero: 1, nome: 'A Ressurreição de Jesus', meditacao: 'No terceiro dia, Jesus ressuscita glorioso dos mortos. O sepulcro está vazio. Aparece a Maria Madalena, aos discípulos de Emaús e aos Apóstolos reunidos. A morte foi vencida!', intencao: "", gracas: "" },
      { numero: 2, nome: 'A Ascensão de Jesus ao Céu', meditacao: 'Quarenta dias após a Ressurreição, Jesus sobe ao céu na presença dos apóstolos. Os anjos anunciam: "Este Jesus que foi arrebatado de vós para o céu virá do mesmo modo que o vistes partir."', intencao: "", gracas: "" },
      { numero: 3, nome: 'A Vinda do Espírito Santo', meditacao: 'No dia de Pentecostes, o Espírito Santo desce sobre Maria e os Apóstolos em forma de línguas de fogo. Cheios do Espírito, saem a proclamar corajosamente a Boa-Nova de Jesus ressuscitado.', intencao: "", gracas: "" },
      { numero: 4, nome: 'A Assunção de Maria ao Céu', meditacao: 'Ao fim de sua vida terrena, Maria é assumida ao céu em corpo e alma. Ela que acolheu o Filho de Deus em seu seio, é agora recebida na glória celeste junto ao Filho ressuscitado.', intencao: "", gracas: "" },
      { numero: 5, nome: 'A Coroação de Maria Rainha', meditacao: 'Maria é coroada Rainha do Céu e da Terra, dos Anjos e dos Santos. Intercede continuamente por seus filhos, sendo o grande sinal de esperança e consolo até que venha o dia do Senhor.', intencao: "", gracas: "" },
    ],
  },
];
          ...
          <div className="space-y-6">
            ...
            {[
              ...
              },
              {
                ...
                descricao: 'Segurando o crucifixo, recite o Credo Apostólico como profissão de fé. Esta oração resume toda a crença cristã.',
                icone: '📜',
              },
              {
                passo: 3,
              ...
              },
              {
                ...
                descricao: 'Nas três contas pequenas seguintes, reze uma Ave Maria em cada uma, pedindo o aumento da fé, da esperança e da caridade.',
                icone: '📿',
              },
              {
                passo: 5,
              ...
              },
              {
                ...
                descricao: 'Ao concluir os cinco mistérios, reze a Salve Rainha. Você pode acrescentar outras orações marianas de devoção pessoal.',
                icone: '👑',
              },
              {
                passo: 10,
